...
val test120 = score_challenge ([(Hearts, Ace),(Clubs, Num 4)],10) = 5
val test121 = score_challenge ([(Hearts, Ace),(Clubs, Num 9)],10) = 0

val test130 = officiate_challenge ([(Hearts, Num 2),(Clubs, Num 4)],[Draw], 15)
...
val test132 = ((officiate_challenge ([(Clubs,Jack),(Spades,Num(8))],
                         [Draw,Discard(Hearts,Jack)], 42); false) 
                        handle IllegalMove => true)
val test133 = officiate_challenge ([(Clubs,Ace)],
                        [Draw], 42)
val test134 = officiate_challenge ([(Clubs,Ace),(Clubs,Ace)],
                        [Draw,Draw], 42)
val test135 = officiate_challenge ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],
                        [Draw,Draw,Draw], 42)
val test136 = officiate_challenge ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],
                        [Draw,Draw,Draw,Draw], 42)
val test137 = officiate_challenge ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],
                        [Draw,Draw,Draw,Draw,Draw], 35)

val test140 = careful_player ([(Hearts, Num 2),(Clubs, Num 4)],15)
val test141 = careful_player ([(Clubs,Ace),(Spades,Ace),(Clubs,Ace),(Spades,Ace)],42)
val test142 = careful_player ([(Clubs,Jack),(Spades,Num(8))],42)
val test143 = careful_player ([(Clubs,Ace)],42)
val test144 = careful_player ([(Clubs,Ace),(Clubs,Ace)],42)
val test145 = careful_player ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],42)
val test146 = careful_player ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],42)
val test147 = careful_player ([(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace),(Clubs,Ace)],42)
